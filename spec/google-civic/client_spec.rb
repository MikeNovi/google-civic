...
describe GoogleCivic::Client do
  ...
  describe "#voter_info" do
    it "should return the voter information from an address" do
      stub_get("/voterinfo?electionId=2000&address=1263%20Pacific%20Ave.%20Kansas%20City%20KS&key=abc123").
    ...
    it "should take a query parameter" do
      stub_get("/voterinfo?electionId=2000&address=1263%20Pacific%20Ave.%20Kansas%20City%20KS&includeOffices=true&key=abc123").
        to_return(:status => 200, :body => fixture("voter_info.json"), :headers => {})
